 ...
 *
 * Output Format
 * Return a single integer denoting the maximum total value of A such that sum of
 ...
 * Explanation 1:
 *
 * Taking the full items with weight 10 and 20 and 2/3 of the item with weight 30
 * will give us
...
public class Fractional_Knapsack {
    ...
    class Pair {
        ...
        public Pair(int value, int weight) {
            this.value = value;
            this.weight = weight;
            this.avg = (1.0d * this.value) / this.weight;
        }
    ...
    public int solve(ArrayList<Integer> A, ArrayList<Integer> B, int C) {
        ...
        Collections.sort(pairs, (o1, o2) -> Double.compare(o1.avg, o2.avg));
